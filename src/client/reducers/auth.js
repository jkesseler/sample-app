...
export const setCurrentUser = user => dispatch => new Promise((resolve) => {
  dispatch({
...
export const establishCurrentUser = () => dispatch => new Promise((resolve) => {
...
export const loginUser = (email, password) => dispatch => new Promise((resolve, reject) => {
  const user = {
    email,
    password,
    name: 'Awesome User',
